...
// Bottom tab bar. The three challenge-lifecycle tabs (Fremgang / Læselog /
// Indstillinger) are grouped together; a hairline divider sets Bingo apart on the
// right, since it's a standalone seasonal feature (see BingoScreen / lib/bingo.ts).
// Active tab is amber accent, inactive is muted. State-driven (no routing).
...
export default function BottomNav() {
  ...
  return (
    ...
    >
      ...
      {/* Hairline divider sets the standalone Bingo tab apart */}
      <div
        aria-hidden
        className="my-auto mx-0.5 h-7 w-px shrink-0"
        style={{ background: "linear-gradient(#F2E6D2, #EAD9BD, #F2E6D2)" }}
      />
